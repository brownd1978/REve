  ...
  struct DrawOptions{
    ...
    class REveMainWindow  : public REX::REveElement {
        ...
        public :
            ...
            void showNodesByName(TGeoNode* n, const std::string& str, bool onOff, int _diagLevel, REX::REveTrans& trans,  REX::REveElement* holder, int maxlevel, int level, bool shift, bool crystal, bool crvshift, bool STshift, bool PSshift, bool TSshift);
            void SolenoidsOnly(TGeoNode* node, REX::REveTrans& trans,  REX::REveElement* holder, int maxlevel, int level, bool addCRV, bool addPS, bool addTS); 
            void makeGeometryScene(REX::REveManager *eveMng, bool addCRV, bool addPS, bool addTS, std::string filename);
